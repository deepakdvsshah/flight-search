...
export class FlightDestinationsService {
     ...
     */
    public getFlightDestinations(origin: string, departureDate?: string, oneWay?: boolean, duration?: string, nonStop?: boolean, maxPrice?: number, viewBy?: 'COUNTRY' | 'DATE' | 'DESTINATION' | 'DURATION' | 'WEEK', observe?: 'body', reportProgress?: boolean): Observable<FlightDestinations>;
    public getFlightDestinations(origin: string, departureDate?: string, oneWay?: boolean, duration?: string, nonStop?: boolean, maxPrice?: number, viewBy?: 'COUNTRY' | 'DATE' | 'DESTINATION' | 'DURATION' | 'WEEK', observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<FlightDestinations>>;
    public getFlightDestinations(origin: string, departureDate?: string, oneWay?: boolean, duration?: string, nonStop?: boolean, maxPrice?: number, viewBy?: 'COUNTRY' | 'DATE' | 'DESTINATION' | 'DURATION' | 'WEEK', observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<FlightDestinations>>;
    public getFlightDestinations(origin: string, departureDate?: string, oneWay?: boolean, duration?: string, nonStop?: boolean, maxPrice?: number, viewBy?: 'COUNTRY' | 'DATE' | 'DESTINATION' | 'DURATION' | 'WEEK', observe: any = 'body', reportProgress: boolean = false): Observable<any> {
        ...
        return this.httpClient.get<FlightDestinations>(`${this.basePath}/shopping/flight-destinations`,
            {
