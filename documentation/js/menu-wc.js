                ...
                <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            ...
                            <li class="link">
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-fab923b766ab602124baaad03511c54d"' : 'data-target="#xs-components-links-module-AppModule-fab923b766ab602124baaad03511c54d"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-fab923b766ab602124baaad03511c54d"' :
                                            'id="xs-components-links-module-AppModule-fab923b766ab602124baaad03511c54d"' }>
                                            <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/SharedSearchModule.html" data-type="entity-link">SharedSearchModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-SharedSearchModule-9e9dd30d898f8b576c4f4acfcceeb536"' : 'data-target="#xs-components-links-module-SharedSearchModule-9e9dd30d898f8b576c4f4acfcceeb536"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-SharedSearchModule-9e9dd30d898f8b576c4f4acfcceeb536"' :
                                            'id="xs-components-links-module-SharedSearchModule-9e9dd30d898f8b576c4f4acfcceeb536"' }>
                                            <li class="link">
                                ...
                                <li class="chapter inner">
                                    <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                        'data-target="#injectables-links-module-SharedSearchModule-9e9dd30d898f8b576c4f4acfcceeb536"' : 'data-target="#xs-injectables-links-module-SharedSearchModule-9e9dd30d898f8b576c4f4acfcceeb536"' }>
                                        <span class="icon ion-md-arrow-round-down"></span>
                                        <span>Injectables</span>
                                        <span class="icon ion-ios-arrow-down"></span>
                                    </div>
                                    <ul class="links collapse" ${ isNormalMode ? 'id="injectables-links-module-SharedSearchModule-9e9dd30d898f8b576c4f4acfcceeb536"' :
                                        'id="xs-injectables-links-module-SharedSearchModule-9e9dd30d898f8b576c4f4acfcceeb536"' }>
                                        <li class="link">
                                            <a href="injectables/FlightDestinationsService.html"
                                                data-type="entity-link" data-context="sub-entity" data-context-id="modules" }>FlightDestinationsService</a>
                                        </li>
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/GetAccessToken.html" data-type="entity-link">GetAccessToken</a>
                            </li>
                            <li class="link">
                                <a href="classes/GetFlightList.html" data-type="entity-link">GetFlightList</a>
                            </li>
                            <li class="link">
                                <a href="classes/GetFlightListFail.html" data-type="entity-link">GetFlightListFail</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
